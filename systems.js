...
const LEADERBOARD_KEY = "security_game_leaderboard_v2"; /* v1 sıfırlandı */
...
(function clearOldLeaderboardsOnce() {
    try {
        if (localStorage.getItem("son_nobet_lb_reset_v2") === "1") return;
        ...
        localStorage.setItem("son_nobet_lb_reset_v2", "1");
    } catch (e) {}
})();
