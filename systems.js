...
const LEADERBOARD_KEY = "security_game_leaderboard_v3"; /* liderlik tekrar sıfırlandı */
...
(function clearOldLeaderboardsOnce() {
    try {
        if (localStorage.getItem("son_nobet_lb_reset_v3") === "1") return;
        ...
        localStorage.setItem("son_nobet_lb_reset_v3", "1");
    } catch (e) {}
})();
