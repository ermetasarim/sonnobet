...
(function FeaturesV55() {
    ...
    function isUnlocked(inst) {
        ...
        const shifts = Number(getShiftCount());
        const n = Number.isFinite(shifts) ? shifts : 0;
        return n >= need;
    }

    function refreshInstitutionLocks() {
        const shifts = Number(getShiftCount()) || 0;
        document.querySelectorAll("#institutionScreen .institutionBtn").forEach((btn) => {
            ...
            // disabled kullanma — tıklamayı tamamen öldürür; kilit handler ile kontrol
            btn.disabled = false;
