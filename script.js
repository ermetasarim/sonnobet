...
$("startBtn").addEventListener("click", () => {
    ...
    // Veriler senkron yüklendi (olaylar.js + senaryo_soru_bankasi.js)
...
function startShift() {
    ...
    // Her vardiya: kurum için rastgele paket + 15 benzersiz senaryo
...
function buildShiftDeck(institution) {
    ...
    // 1) Öncelik: konuştuğumuz senaryo soru bankası (15 soru / 4 şık)
