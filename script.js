...
const backToInstBtnText = $("backToInstBtnText");
if (backToInstBtnText) {
    backToInstBtnText.addEventListener("click", leaveShiftToInstitution);
}
